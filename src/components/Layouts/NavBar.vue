...
const title = computed(() => {
  ...
  return name.map((n: string) => n.charAt(0).toUpperCase() + n.slice(1)).join(' ')
})
...
<template>
  <div :class="$style.header">
    <div :class="$style.headerSection">
      <button :class="$style.headerIconCollapse" @click="$emit('toggleSidebar')">
          ...
          <div :class="$style.headerRightPopup">
            <div :class="$style.headerRightPopupItem">
              <div :class="$style.headerRightPopupItemChild">
                <Icon icon="material-symbols:logout" :class="$style.headerRightPopupItemChildIcon" style="color: #5f6368" />
            ...
            <div :class="$style.headerRightPopupItem">
              <div :class="$style.headerRightPopupItemChild">
                <Icon icon="solar:moon-linear" :class="$style.headerRightPopupItemChildIcon" style="color: #5f6368" />
            ...
            <div :class="$style.headerRightPopupItem">
              <div :class="$style.headerRightPopupItemChild">
                <Icon icon="ph:question" :class="$style.headerRightPopupItemChildIcon" style="color: #5f6368" />
                <span :class="$style.headerRightPopupItemText">Help Center</span>
              </div>
            </div>
            <div :class="$style.headerRightPopupItem">
              <div :class="$style.headerRightPopupItemChild">
                <Icon icon="ic:outline-email" :class="$style.headerRightPopupItemChildIcon" style="color: #5f6368" />
